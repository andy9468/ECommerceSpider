...
ECommerceSpider 是一个基于 **DrissionPage + SQLAlchemy + lxml + asyncio** 的异步并发的电商数据采集系统。
...
├── docs             # 文档
│   ├── 部署文档.md           # 使用说明文档
│   └── greenlet编译问题解决方案.md  # 依赖安装问题解决方案
├── LICENSE
├── models           # 数据模型模块
│   ├── GoodsModel.py
│   └── __init__.py
...
添加联系时，请备注：项目名称+意图。如：电商爬虫+交流

![image-20260321233407029](.assets/image-20260321233407029.png)